...
def faceDetection(test_img):
    ...
    face_haar_cascade= cv2.CascadeClassifier('F:/master thesis/thesis/haar cascade/haarcascade_frontalface_default.xml')
    faces=face_haar_cascade.detectMultiScale(gray_img,scaleFactor=1.4,minNeighbors=5)
